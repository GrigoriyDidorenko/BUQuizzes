            ...
            var qmass = $.each(testinfo.questions, function (i, questionone) {
                ...
                $.each(questionone.answers, function (j, answersone) {
                    ...
                    if (questionone.multichoice) {
                        span.html('<p class="positions"><input type="checkbox" value="' + answersone.answerText + '" name="answer' + i + '" id ="'+answersone.id+'" class="positions filled-in"><label class="positions" for="'+answersone.id+'">' +
                            answersone.answerText + '</label></p>')
                    } else {
                        span.html('<p class="positions"><input type="radio" value="' + answersone.answerText + '" name="answer' + i + '" id ="'+answersone.id+'" class="positions with-gap"><label class="positions" for="'+answersone.id+'">' +
                            answersone.answerText + '</label></p>')
                    }
                    div_q.append(span);
                });
